...
references:
  - "_docs/qa/Workflow/why-first-fixture/test-plan.md"
  - "_docs/intent/Workflow/why-first-fixture/decision.md"
related_issues: []
related_prs: []
fixture_path: "_docs/qa/Workflow/why-first-fixture/verification.md"
---
...
| --- | --- | --- |
| `deno run --allow-read scripts/validate-qa.ts --fixture _evals/validator-fixtures/qa/invalid/verification-in-progress-status.md` | FAIL | Completed verification cannot remain in progress. |
